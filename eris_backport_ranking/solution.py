...
def select_device() -> torch.device:
    """The A10G when the run is on one (guidebook 3.6), with determinism forced.

    A device choice made once at startup, not a speed-dependent fallback: the
    hyperparameters, epoch counts, seeds and fit counts below are identical either way.
    """
